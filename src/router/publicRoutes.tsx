...
const CreatePassword = lazy(() => import("@/pages/auth/create-password/CreatePassword.tsx"));
const ForgotPassword = lazy(() => import("@/pages/auth/forgot-password/ForgotPassword.tsx"));
