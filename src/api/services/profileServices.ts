...
export const profileServices = {
  ...
  getProfile: (): Promise<IApiProfileSuccess> => axiosClient.get("/v1/profile"),

  // API 3.6.2: PUT /api/v1/profile
  updateProfile: (
    payload: IUpdateProfilePayload,
  ): Promise<IApiProfileSuccess> => axiosClient.put("/v1/profile", payload),
  ...
  unlinkOAuth: (
    payload: IUnlinkOAuthPayload,
  ): Promise<IApiUnlinkOAuthSuccess> =>
