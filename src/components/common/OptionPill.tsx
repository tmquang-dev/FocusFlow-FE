...
export function OptionPill({
  ...
  return (
    <label
      htmlFor={id}
      className={`cursor-pointer inline-flex items-center justify-center w-14.25 h-6 rounded-full text-xs font-text-default border transition-all duration-200 select-none shrink-0 ${
        isChecked
