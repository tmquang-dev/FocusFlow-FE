...
export const STATUS_THEMES: Record<ColumnId, StatusTheme> = {
  BACKLOG: {
    label: "BACKLOG",
    headerClass:
      "bg-gray-100 border-gray-900 border-solid border-t border-r border-b-2 border-l-2",
    countClass: "text-gray-900",
    cardClass:
      "bg-gray-50 border-border-hover hover:bg-gray-100 active:bg-gray-200",
  ...
  TO_DO: {
    label: "TO DO",
    headerClass:
      "bg-primary-100 border-primary-700 border-solid border-t border-r border-b-2 border-l-2",
    countClass: "text-primary-600",
    cardClass:
      "bg-primary-50 border-primary-400 hover:bg-primary-100 active:bg-primary-200",
  ...
  IN_PROGRESS: {
    label: "IN PROGRESS",
    headerClass:
      "bg-amber-100 border-amber-900 border-solid border-t border-r border-b-2 border-l-2",
  ...
  DONE: {
    label: "DONE",
    headerClass:
      "bg-green-100 border-green-900 border-solid border-t border-r border-b-2 border-l-2",
    countClass: "text-green-600",
    cardClass:
      "line-through decoration-gray-400 bg-green-50 border-green-400 opacity-60 hover:bg-green-100 active:bg-green-200",
